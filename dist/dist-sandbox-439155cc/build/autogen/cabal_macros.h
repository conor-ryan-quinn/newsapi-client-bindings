...
/* package ClientBindings-0.1.0.0 */
#define VERSION_ClientBindings "0.1.0.0"
#define MIN_VERSION_ClientBindings(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package servant-0.13.0.1 */
#define VERSION_servant "0.13.0.1"
#define MIN_VERSION_servant(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  13 || \
  (major1) == 0 && (major2) == 13 && (minor) <= 0)

/* package servant-client-0.13.0.1 */
#define VERSION_servant_client "0.13.0.1"
...
#define CURRENT_COMPONENT_ID "ClientBindings-0.1.0.0-EH8Seu5lSS5AyIWAZi4Rt6"

#define CURRENT_PACKAGE_KEY "ClientBindings-0.1.0.0-EH8Seu5lSS5AyIWAZi4Rt6"
